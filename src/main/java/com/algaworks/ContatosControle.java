...
public class ContatosControle {
	...
	static {
		LISTA_CONTATOS.add(new Contato("1", "Maria", "+55 34 91234-5678"));
		LISTA_CONTATOS.add(new Contato("2", "João", "+55 83 91234-5678"));
		LISTA_CONTATOS.add(new Contato("3", "Fulano", "+55 61 91234-5678"));
		LISTA_CONTATOS.add(new Contato("4", "Ciclano", "+55 11 91234-5678"));
		LISTA_CONTATOS.add(new Contato("5", "Beltrano", "+55 21 91234-5678"));
	}
